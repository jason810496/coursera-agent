...
class CourseWeek(BaseModel):
    ...
    path: str = Field(
        examples="/path/to/interactive-python-1/01_week-0-statements-expressions-variables"
    )
...
class KeyPoint(BaseModel):
    ...
    path: str = Field(
        examples="/path/to/interactive-python-1/01_week-0-statements-expressions-variables/01_week-0a-expressions/variables"
    )
